...
from universalclassifier.run.default_configuration import get_default_configuration
...
def run_training(args):
    ...
    if network == "3d_cascade_fullres":  # 3d_cascade_fullres not implemented for universal classifier
        assert issubclass(trainer_class, (nnUNetTrainerCascadeFullRes, nnUNetTrainerV2CascadeFullRes)), \
            "If running 3d_cascade_fullres then your " \
            "trainer class must be derived from " \
            "nnUNetTrainerCascadeFullRes"
    #else: #  does not apply to universal classifier
